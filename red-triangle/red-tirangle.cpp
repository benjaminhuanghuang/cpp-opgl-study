/*
    ...
    https://github.com/opengl-tutorials/ogl/blob/master/tutorial02_red_triangle/tutorial02.cpp

    Draw a triangle
    1. create a Vertex Array Object (VAO) and set it as the current one :
