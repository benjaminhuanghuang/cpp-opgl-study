...
int main(void)
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        GLint lightPosLoc = glGetUniformLocation(lightingShader.GetShaderProgram(), "lightPos");
        GLint viewPosLoc = glGetUniformLocation(lightingShader.GetShaderProgram(), "viewPos");
